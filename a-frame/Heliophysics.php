    ...
    <a-scene>
        <a-assets>
           ...
           <!-- scenes space-->
            ...
            <img id="satel" src="https://i.ibb.co/xqXMZfX/sat-removebg-preview.png" crossorigin="anonymous">  
        ...
        <a-image src="#planet1" position="-15 5 -20"  width="2" height="1.1637"  scale="1 1 1"></a-image>
        ...
        <a-image src="#satel" position="8 2 -6"  width="1" height="0.75"  scale="1 1 1"></a-image>
