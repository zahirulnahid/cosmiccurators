...
<body>
    <a-scene>
        <a-assets>
            ...
            <img id="earthF" src="https://i.ibb.co/1s3V5Gj/earth2-removebg-preview.png" crossorigin="anonymous"> 
        ...
        <a-image src="#exp2TIMED" position="0 3 -4"  
                                  width="3" 
                                  height="1.68"  
                                  scale="1 1 1" 
                                  rotation="0 50 0"></a-image>
        <a-image src="#exp2TT" position="0 3 -7"  
                               width="3" 
                               height="1.68"  
                               scale="1 1 1" 
                               rotation="0 50 0"></a-image>
        ...
        <a-image src="#imp1Hermes" position="-3 -3 -4"  
                                   width="3" 
                                   height="3"  
                                   scale="1 1 1" 
                                   rotation="0 50 0"></a-image>
        ...
        <a-image src="#sun" position="-10 0 -5"  
                            width="3" 
                            height="3"          
                            scale="3 3 3" 
                            rotation="0 50 0"></a-image>
        <!--<a-image src="#galaxy" position="-20 0 -3"  width="1" height="0.75" rotation="0 100 0" scale="2 2 2"></a-image> -->
        <a-image src="#astro2" position="9 -1 2"  
                               width="1" 
                               height="1.776" 
                               rotation="0 100 0" 
                               scale="1 1 1"></a-image>

        <a-image src="#planet1" position="-15 3" 
                                width="2" height="1.1637"  scale="1 1 1"></a-image>
        ...
        <a-text value="Float around" color="#C0C0C0" scale="10 10 10" position="-5 -2 -15"></a-text>
        <a-text value="to see the space" color="#C0C0C0" scale="10 10 10" position="-5 -4 -15"></a-text>

        <a-image src="#psp" position="-5 0 -5"  width="0.5" height="0.348"  scale="4 4 4"></a-image>
        
        <a-image src="#earthF" position="20 0 -5"  width="3" height="2.202"  scale="6 6 6" rotation="10 -50 0"></a-image>
